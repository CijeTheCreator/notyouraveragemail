                ...
                await buddyDictationManager.startPushToTalkFromKeyboardShortcut(
                    ...
                    submitDraftText: { [weak self] finalTranscript in
                        ...
                        Task { @MainActor in
                            ...
                            let appContext = await AppContextRegistry.shared.collectCurrentContext()
                            let lower = finalTranscript.lowercased()
                            let isEmailIntent = lower.contains("email") || lower.contains("send") || lower.contains("draft") || lower.contains("mail") || lower.contains("attach")

                            if !appContext.files.isEmpty || isEmailIntent {
